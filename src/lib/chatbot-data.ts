...
export const chatbotConfig: ChatbotConfig = {
  ...
  topics: [
    ...
    },
    {
      ...
      href: "/eco-living",
      hrefLabel: "Explore Saiccha Wisdom Valley",
    },
    {
      id: "education",
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "Not yet. This is a concept currently in development. The Phase-1 master plan covers 20.4 acres for the Gurukul campus, and Phase 1 of the Saiccha Wisdom Valley scheme plans 1,000 of a total 3,000 plots.",
    },
    {
      id: "difference",
      question: "What's the difference between the Gurukul campus and Saiccha Wisdom Valley?",
      answer:
        "The Gurukul campus is the education, wellness, and research campus itself. Saiccha Wisdom Valley is the gated, plotted residential scheme built right beside it, one integrated development in two parts.",
    },
    {
      id: "founders",

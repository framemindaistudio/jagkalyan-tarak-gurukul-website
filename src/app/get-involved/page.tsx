  ...
  return (
    <>
      ...
      <div className="relative aspect-[21/9] w-full overflow-hidden">
        <Image
          src="/images/jk-get-involved-banner.jpg"
          alt="Mentors and students collaborating outdoors on the JagKalyan Tarak Gurukul campus"
          fill
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            {getInvolvedOptions.map((option) => (
              <div
                key={option.key}
                id={option.key}
                className="scroll-mt-28 flex flex-col gap-4 rounded-card border border-border bg-surface-raised p-7"
              >
